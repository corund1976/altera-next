...
const fileName = 'Альтера - Каталог загородная недвижимость.pdf';

function SectionE() {
  const dispatch = useDispatch();

  const fileUrl = useSelector(dataSelectors.downloadUrls)?.house_pdf_url;
    ...
    <section className={s.section}>
      <div className={s.container}>
        <div className={s.block}>
          ...
          {sendFeedback === 'countryside_catalog' ? (
            <div>
            ...
            <form onSubmit={handleSubmit} className={s.form}>
              ...
              <p className={s.text}>
                эксклюзивный каталог загородных домов с участками
              </p>
              <label
                htmlFor="suburbanDownloadInputPhone"
                className={s.label_phone}
              >
                <p>Телефон</p>
                <input
                  type="text"
                  id="suburbanDownloadInputPhone"
                  value={phone}
              ...
              <label
                htmlFor="suburbanDownloadInputName"
                className={s.label_name}
              >
                <p>Имя</p>
                <input
                  type="text"
                  id="suburbanDownloadInputName"
                  value={name}
