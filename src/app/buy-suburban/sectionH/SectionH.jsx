...
function SectionH() {
  ...
  const handleSubmit = (e) => {
    ...
    const data = {
      ...
      name: name.trim(),
      context: 'dream_house_consultation',
    };

    dispatch(dispatch(dataOperations.sendFeedback(data)));
  };
  ...
  return (
    <section className={s.section} id="form">
      <div className={s.container}>
        <div className={s.block}>
          <Image src={picture} alt="picture" className={s.form_picture} />
          {sendFeedback === 'dream_house_consultation' ? (
            <div>
            ...
            <form onSubmit={handleSubmit} className={s.form}>
              <p className={s.title}>записаться</p>
              <p className={s.text}>
                на бесплатную консультацию по подбору дома мечты
              </p>
              <label
                htmlFor="suburbanRequestInputPhone"
                className={s.label_phone}
              >
                <p>Телефон</p>
                <input
                  type="text"
                  id="suburbanRequestInputPhone"
                  value={phone}
              ...
              <label
                htmlFor="suburbanRequestInputName"
                className={s.label_name}
              >
                <p>Имя</p>
                <input
                  type="text"
                  id="suburbanRequestInputName"
                  value={name}
