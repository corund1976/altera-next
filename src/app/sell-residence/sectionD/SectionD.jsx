    ...
    <section className={s.section} id="form">
      <div className={s.container}>
        <div className={s.block}>
          ...
          {sendFeedback === 'sell_apartment_agent' ? (
            <div>
            ...
            <form onSubmit={handleSubmit} className={s.form}>
              <p className={s.title}>Хочу выгодно продать</p>
              <p className={s.text}>квартиру с помощью агента</p>
              <label htmlFor="sellInputPhone" className={s.label_phone}>
                <p>Телефон</p>
                <input
                  type="text"
                  id="sellInputPhone"
              ...
              <label htmlFor="sellInputName" className={s.label_name}>
                <p>Имя</p>
                <input
                  type="text"
                  id="sellInputName"
