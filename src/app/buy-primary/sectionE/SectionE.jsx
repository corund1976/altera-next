...
const fileName = 'Альтера - Каталог новостройки.pdf';

function SectionE() {
  const dispatch = useDispatch();

  const fileUrl = useSelector(dataSelectors.downloadUrls)?.apartments_pdf_url;
    ...
    <section className={s.section}>
      <div className={s.container}>
        <div className={s.block}>
          ...
          {sendFeedback === 'installment_catalog' ? (
            <div>
            ...
            <form onSubmit={handleSubmit} className={s.form}>
              ...
              <p className={s.text}>
                эксклюзивный каталог новостроек с рассрочкой
              </p>
              <label
