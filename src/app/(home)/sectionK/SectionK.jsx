...
import s from './sectionK.module.css';
    ...
    <section className={s.section} id="form">
      <div className={s.container}>
        <div className={s.block}>
          ...
          {sendFeedback === 'consultation_question' ? (
            <div>
            ...
            <form onSubmit={handleSubmit} className={s.form}>
              <p className={s.title}>Остались вопросы?</p>
              <p className={s.text}>Запишитесь на бесплатную консультацию</p>
              <label htmlFor="feedbackInputPhone" className={s.label_phone}>
                <p>Телефон</p>
                <input
                  type="text"
                  id="feedbackInputPhone"
                  value={phone}
              ...
              <label htmlFor="feedbackInputName" className={s.label_name}>
                <p>Имя</p>
                <input
                  type="text"
