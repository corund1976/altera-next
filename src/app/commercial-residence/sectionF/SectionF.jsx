    ...
    <section className={s.section} id="form">
      <div className={s.container}>
        <div className={s.block}>
          ...
          {sendFeedback === 'commercial_profit' ? (
            <div>
            ...
            <form onSubmit={handleSubmit} className={s.form}>
              ...
              <p className={s.text}>
                с вашим коммерческим объектом! Бесплатный аудит от «Альтера»
                покажет, как увеличить доход и привлечь арендаторов. Оставьте
                заявку!
              </p>
              <label htmlFor="requestInputPhone" className={s.label_phone}>
                <p>Телефон</p>
                <input
                  type="text"
              ...
              <label htmlFor="requestInputName" className={s.label_name}>
                <p>Имя</p>
                <input
                  type="text"
                  id="requestInputName"
